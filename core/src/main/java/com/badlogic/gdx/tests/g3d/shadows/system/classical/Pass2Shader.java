...
public class Pass2Shader extends DefaultShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.internal("shaders/shadowsystem/classical/pass2.vertex.glsl")
					.readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.internal("shaders/shadowsystem/classical/pass2.fragment.glsl")
					.readString();
